...
const localDateTime = (value) => value ? formatDateTime(value, 'en-EG') : ''
...
export default function Notes() {
  ...
  return <div className="space-y-6">
    ...
    <ConfirmDeleteModal open={Boolean(deleteTarget)} onClose={() => setDeleteTarget(null)} onConfirm={remove} loading={deleting} title="Delete note?" message={`Delete ${deleteTarget?.title || 'this note'}? This action cannot be undone.`}/>
  </div>
}
